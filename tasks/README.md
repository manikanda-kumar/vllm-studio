...
| 09 | Controller integration test (real HTTP) | [09-controller-integration.md](09-controller-integration.md) | `[ ]` | — |
| 10 | `npm run verify` aggregator + JSON reporter | [10-verify-aggregator.md](10-verify-aggregator.md) | `[ ]` | 02, 04 |
