  ...
  return (
    <div className="space-y-5">
      ...
      >
        ...
        <SettingsRow
          label="Default model"
          description="Optional default routing slug, e.g. openai/gpt-4o or anthropic/claude-3.5-sonnet."
          control={
            <SettingsInput
          ...
          status={
            <StatusPill tone={apiSettings.defaultModel ? "info" : "default"}>
              {apiSettings.defaultModel ? "set" : "unset"}
            </StatusPill>
          }
        />
        <SettingsRow
