...
const SECTION_TUPLES: SectionTuple[] = [
  ...
  ["providers", "Providers", "External model providers and keys.", Blocks, true],
  ["engines", "Engines", "Runtime targets, installers, GPU lease.", Cpu, false],
  ["services", "Services", "Controller, inference, frontend topology.", Network, false],
  ["system", "System", "Storage, hardware, compatibility checks.", ServerCog, false],
  ["appearance", "Appearance", "Theme variables, typography, density.", Paintbrush, true],
  ["agent", "Agent tools", "Files, git, browser, computer, and design defaults.", Bot, true],
];
